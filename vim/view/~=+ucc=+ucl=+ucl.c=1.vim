...
nmap <buffer> <silent> J i=C_JumpCtrlJ()
...
imap <buffer> <silent> J =C_JumpCtrlJ()
...
setlocal define=
setlocal dictionary=~/Gitstuff/maximum-awesome/vim/bundle/c.vim/c-support/wordlists/c-c++-keywords.list,~/Gitstuff/maximum-awesome/vim/bundle/c.vim/c-support/wordlists/k+r.list,~/Gitstuff/maximum-awesome/vim/bundle/c.vim/c-support/wordlists/stl_index.list
setlocal nodiff
setlocal equalprg=
...
111
normal zc
let s:l = 34 - ((12 * winheight(0) + 17) / 34)
